...
import com.langmeng.common.json.JSONObject;
import com.langmeng.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "langmeng 1", "langmeng 2", "langmeng 3", "langmeng 4", "langmeng 5" };
        AjaxResult ajax = new AjaxResult();
